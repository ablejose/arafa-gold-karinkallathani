...
export const BRAND: BrandConfig = {
  ...
  tagline: "Your Trusted Jewellery Destination in Karinkallathani",
  description:
    "Arafa Gold is Karinkallathani's trusted destination for gold, diamond, and silver jewellery. Serving Karinkallathani and the surrounding areas with timeless craftsmanship and a wide collection to suit every celebration and every budget.",
  ...
  storyVideos: [
    ...
    {
      quote: "കാരിങ്കൽ‌ത്തണിയുടെ ഹൃദയത്തിൽ നിന്ന്.",
      description:
  ...
  city: "Karinkallathani",
  state: "Kerala",
  pincode: "679341",

  phone: "+919562495951",
  whatsapp: "919562495951",
  email: "",
  ...
  seo: {
    title: "Arafa Gold | Gold & Jewellery in Karinkallathani",
    description:
      "Arafa Gold — Karinkallathani's destination for gold, diamond and silver jewellery. Beautiful collections for every celebration. Karinkallathani, Kerala.",
    keywords: [
      "Arafa Gold",
      ...
      "gold shop Karinkallathani",
      "jewellery Kerala"
    ],
    canonical: "https://arafa-gold-karinkallathani.vercel.app",
    ogImage:
      "/images/store1.webp",
  },
